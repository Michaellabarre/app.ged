    ...
    <div class="container-fluid">
        ...
        <div class="bg-white card-toggle-body m-l-0 m-r-0 box-shadow ">
            <div class="button-list">
                <a href="{{route('nouveauMail')}}"><button type="button" class="btn btn-success btn-flat btn-addon btn-lg m-b-10 m-l-5">NOUVEAU MESSAGE</button></a>
                <a href="{{route('boiteReception')}}"><button type="button" class="btn btn-success btn-flat btn-addon btn-lg m-b-10 m-l-5">BOITE DE RECEPTION</button></a>
                <a href="{{route('messageEnvoye')}}"> <button type="button" class="btn btn-success btn-flat btn-addon btn-lg m-b-10 m-l-5">MESSAGE ENVOYES </button></a>
            </div>
        </div>
