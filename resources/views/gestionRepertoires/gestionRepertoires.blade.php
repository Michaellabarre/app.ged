    ...
    <div class="container-fluid">
        ...
        <div class="bg-white card-toggle-body m-l-0 m-r-0 box-shadow ">
            <div class="button-list">
                <a href="#"><button type="button" class="btn btn-success btn-flat btn-addon btn-lg m-b-10 m-l-5">Ajouter Repertoire</button></a>
                <a href="#"><button type="button" class="btn btn-success btn-flat btn-addon btn-lg m-b-10 m-l-5">Visualiser Repertoire</button></a>
